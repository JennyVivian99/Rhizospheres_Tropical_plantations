...
# Taxa
after_rar_num_asvsBulkRhizo1_2YO<- ntaxa(ps_rarefiedBulkRhizo1_2YO)
after_rar_num_asvsBulkRhizo1_2YO
# Check
summarize_phyloseq(ps_rarefiedBulkRhizo1_2YO)
sample_sums(ps_rarefiedBulkRhizo1_2YO)[order(sample_sums(ps_rarefiedBulkRhizo1_2YO))]
...
sample_sums(ps_rarefiedBulkRhizo2YO)[order(sample_sums(ps_rarefiedBulkRhizo2YO))]
ps_rarefiedBulkRhizo2YO
# Check the structure
str(sample_data(ps_rarefiedBulkRhizo2YO))
# For publications is useful:
otu_counts <- as.matrix(otu_table(ps_rarefiedBulkRhizo2YO))
total_sequence_reads <- sum(otu_counts)
total_sequence_reads
...
sample_sums(ps_rarefiedBulkRhizo10YO)[order(sample_sums(ps_rarefiedBulkRhizo10YO))]
ps_rarefiedBulkRhizo10YO
# Check the structure
str(sample_data(ps_rarefiedBulkRhizo10YO))
# For publications is useful:
otu_counts <- as.matrix(otu_table(ps_rarefiedBulkRhizo10YO))
total_sequence_reads <- sum(otu_counts)
total_sequence_reads
