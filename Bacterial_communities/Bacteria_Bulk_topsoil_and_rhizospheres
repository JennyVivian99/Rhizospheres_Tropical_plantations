...
otu_dataBulk <- read.csv("feature_table.csv") # CHECK that there is the ID column and that the samples have dots not hyphens
nrow(otu_dataBulk)
...
plot + 
  labs(title = "Bacteria communities 2 and 10yo") +
  theme_bw() +
  theme(
